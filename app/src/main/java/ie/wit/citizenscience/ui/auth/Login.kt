package ie.wit.citizenscience.ui.auth
...
import ie.wit.citizenscience.databinding.LoginBinding
import ie.wit.citizenscience.utils.createLoader
import ie.wit.citizenscience.utils.hideLoader
import ie.wit.citizenscience.utils.showLoader
...
import ie.wit.citizenscience.ui.home.Home
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("Citizen Science Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
